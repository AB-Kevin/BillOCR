...
class PrefixedGitHubProvider extends Provider {
  ...
  // dashes -- e.g. the local build's "BillOCR Intake Setup 0.2.2.exe"
  // really ends up stored as "BillOCR.Intake.Setup.0.2.2.exe", while
  // latest.yml still says "BillOCR-Intake-Setup-0.2.2.exe". Reconstructing
